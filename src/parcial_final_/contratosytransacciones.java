 ...
 * @author COMPUMAX
 */
public class contratosytransacciones extends javax.swing.JFrame {

    /**
     * Creates new form contratosytransacciones
     */
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ARRENDATARIO", "COMPRAVENTA" }));
        ...
        jTabbedPane1.addTab("CONTRATOS", jPanel2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contratosytransacciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new contratosytransacciones().setVisible(true);
            }
        });
    }
